...
def main():
    ...
    old_filter_desc=str("Filter output from analyze step." +
...
#    sp_old_filter_p_required = sp_old_filter_p.add_argument_group('required arguments')
#    sp_old_filter_p_required.add_argument('-i', '--input_file', action='store', dest='ofa_inp', required=True,
#        help='use the output file from analyze section as input')
#    sp_old_filter_p_required.add_argument('-b', '--bed', action='store', dest='fofn_bed', required=True, 
...
#    #    dest='preprocess_dir', default='preprocessed_files',
#    #    help='directory used to store preprocessing output files (default: preprocessed_files)')
#    sp_old_filter_p.add_argument('--align_qual_lim', action='store', dest='qlm_inp', type=float, default=0.75,
#        help='Lowest limit for alignment quality (default: 0.75)')
#    sp_old_filter_p.add_argument('--min_clipped_reads', action='store', dest='tcr_inp', type=int, default=2, 
#        help='Minimum number of clipped reads (default: 2)')
#    sp_old_filter_p.add_argument('--min_clipped_and_dischord_reads', action='store', dest='trd_inp', type=int, default=5, 
#        help='Minimum total [clipped+discordant] reads (default: 5)')
#    sp_old_filter_p.add_argument('--read_percent', action='store', dest='rp_inp', type=float, default=10.0, 
...
#    sp_old_filter_p.add_argument('--log_file', action='store',
#        dest='log_file', default='filter_p.log',
#        help='run log file (default: filter_p.log)')
#    sp_old_filter_p._action_groups.reverse()
